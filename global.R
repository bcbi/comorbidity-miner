...
if (src == 'CSV') {
  ...
  # TODO: test with aeolus
  ehr <- src_mysql(dbname = 'aeolus')
  # collect some tables into memory
  table1 <- collect(tbl(ehr, 'diagnoses_icd'))
  table2 <- collect(tbl(ehr, 'patient_demographics'))
